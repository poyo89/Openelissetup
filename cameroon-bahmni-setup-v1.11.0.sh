...
cd ~
wget -c https://github.com/jembi/cameroon-openmrs-module-bahmniapps/releases/download/v1.11.0/dist-v1.11.0.zip
rm -rf ~/cameroon-bahmniapps
mkdir -p ~/cameroon-bahmniapps
unzip -q ~/dist-v1.11.0.zip -d ~/cameroon-bahmniapps
